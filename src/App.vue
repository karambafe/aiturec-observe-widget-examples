<template>
  <div id="app">
    ...
    <ul>
      <li>Добавляется наблюдатель смены размеры окна (событие resize)</li>
      <li>
      ...
      <li>
        Если отправлены все события для текущего брейкпоинта,
        то снимаются наблюдатели со всех рекомендаций
      </li>
      <li>
        Если отправлены все события для всех брейкпоинтов,
        то снимаются наблюдатели со всех рекомендаций,
        а также наблюдатель размера окна
      </li>
      <li>
        При смене брейкпоинта удаляются старые наблюдатели рекомендаций,
